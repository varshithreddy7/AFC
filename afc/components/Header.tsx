    ...
    >
      <div className="relative h-[130px] flex items-center justify-between px-8">
        ...
        <div className="relative flex gap-10 items-center">
          {tabs.map((tab, index) => (
            <Link
              href={tab.href}
              key={tab.name}
              style={{ textDecoration: 'none' }}  // Add inline style
              className="no-underline hover:no-underline" // Add these classes
            >
              <div
        ...
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
        >
          <div className="relative w-full h-full bg-[#ebbd28] rounded-[30px] flex items-center justify-center gap-2 px-6 cursor-pointer hover:bg-yellow-500 transition-colors">

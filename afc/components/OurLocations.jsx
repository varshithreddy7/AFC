...
const locations = [
  ...
  { 
    ...
    directLink: "" // Please provide the direct Google Maps link
  },
  { 
    city: "Pune", 
        ...
        <motion.div 
          ...
          {locations.map((location, index) => (
            <motion.div
              ...
              className="relative flex flex-col items-center gap-3 text-base font-semibold text-black bg-white/90 backdrop-blur-sm px-8 py-6 rounded-xl shadow-lg border-2 border-black hover:bg-black hover:text-yellow-400 duration-200 w-[320px]"
            >
              <a

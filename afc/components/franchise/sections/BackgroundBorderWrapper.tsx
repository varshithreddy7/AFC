...
export const BackgroundBorderWrapper: React.FC =()=> {
  return (
    <div className="left-[1053px] absolute w-[360px] h-[544px] top-[1246px] bg-[#58554a] rounded border border-solid border-[#00000020] shadow-[12px_12px_30px_#ebbd2880]">
...
export default BackgroundBorderWrapper;
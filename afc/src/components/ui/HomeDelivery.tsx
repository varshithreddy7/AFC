...
const HomeDelivery = () => {
  return (
    <div className="relative bg-black rounded-[30px] overflow-hidden w-[510px] h-[650px] max-w-[95vw] max-h-[95vh] md:w-[510px] md:h-[650px] sm:w-[90vw] sm:h-auto mx-auto">
      <div className="absolute top-[24px] left-1/2 transform -translate-x-1/2 text-[20px] md:text-[24px] font-extrabold text-white tracking-widest">
        ORDER DETAILS
      </div>
      ...
      <div className="absolute top-[200px] left-1/2 transform -translate-x-1/2 text-[#FFD700] font-bold text-[20px] md:text-[22px] text-center">
        Home Food Delivery
      </div>
      ...
      <div className="absolute w-[440px] max-w-[80%] left-1/2 transform -translate-x-1/2 top-[285px]">
      ...
      <div className="absolute bottom-[50px] left-1/2 transform -translate-x-1/2 text-white text-[13px] text-center ">
